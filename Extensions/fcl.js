(function(Scratch) {
	...
	class FCL {
				...
				blocks: [
                    {
                        ...
                        arguments: {
                            code: { type: ArgumentType.STRING, defaultValue: "# e_main cps aps \"hi\" scv \"log\" exc -#" }
                        }
                    },
                    {
                        ...
                        arguments: {
                            code: { type: ArgumentType.STRING, defaultValue: "# e_main cps aps \"hi\" scv \"log\" exc -#" },
                            env: { type: ArgumentType.STRING, defaultValue: "{}" }
                        }
                    },
                    {
                        ...
                        arguments: {
                            code: { type: ArgumentType.STRING, defaultValue: "# e_main scv \"hi\" ret -#" },
                            out: { type: ArgumentType.STRING, defaultValue: "output", menu: 'fcl_out' },
		...
		runCompiledReporter({ code, out, representation }) {
            ...
            if (out == "output") {return data["outval"]}
